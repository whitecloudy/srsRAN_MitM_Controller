...
#include "mitm_lib/asn1/rrc.h"
#include "mitm_lib/asn1/rrc_utils.h"
#include "mitm_lib/common/bcd_helpers.h"
#include "mitm_lib/interfaces/rrc_interface_types.h"
#include <iostream>
...
int meas_obj_test()
{
  ...
  TESTASSERT(area_cfg_r9->pmch_info_list_r9[0]
                 ...
                 .mcc_present);
  srsran::plmn_id_t plmn = srsran::make_plmn_id_t(
