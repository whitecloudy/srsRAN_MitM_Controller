...
#include "mitm_lib/common/time_prof.h"
#include <algorithm>
#include <inttypes.h>
#include <numeric>
...
template class srsran::sliding_window_stats<std::chrono::microseconds>;
template class srsran::sliding_window_stats<std::chrono::milliseconds>;
